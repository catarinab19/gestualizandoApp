...
class CorScreen5 extends StatefulWidget {
  static String routeName = "/cor4_page";

  @override
  _Cor5FormState createState() => _Cor5FormState();
}

class _Cor5FormState extends State<CorScreen5> {
  late VideoPlayerController _controller17;
  ...
  @override
  void initState() {
    _controller17 = VideoPlayerController.asset('assets/videos/cores/azul.mp4');
    _initializeVideoPlayerFuture = _controller17.initialize();

    _controller17.setLooping(true);
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return AspectRatio(
                            aspectRatio: _controller17.value.aspectRatio,
                            child: VideoPlayer(_controller17),
                          );
                        } else {
                  ...
                  SizedBox(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        setState(() {
                          // pause
                          if (_controller17.value.isPlaying) {
                            _controller17.pause();
                          } else {
                            // play
                            _controller17.play();
                      ...
                      onPressed: () {
                        for (var answer in listAnswer.answers) {
                          if (_wordCorrectController.text ==
                              apiMockUp.l1.answers[19].resposta)
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                        ...
                        if (_wordCorrectController.text.isEmpty || _wordCorrectController.text != "azul"){
