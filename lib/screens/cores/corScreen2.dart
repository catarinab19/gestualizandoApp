...
class CorScreen2 extends StatefulWidget {
  static String routeName = "/cor2_page";

  @override
  _Cor2FormState createState() => _Cor2FormState();
}

class _Cor2FormState extends State<CorScreen2> {
  late VideoPlayerController _controller14;
  ...
  @override
  void initState() {
    _controller14 = VideoPlayerController.asset('assets/videos/cores/branco.mp4');
    _initializeVideoPlayerFuture = _controller14.initialize();

    _controller14.setLooping(true);
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return AspectRatio(
                            aspectRatio: _controller14.value.aspectRatio,
                            child: VideoPlayer(_controller14),
                          );
                        } else {
                  ...
                  SizedBox(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        setState(() {
                          // pause
                          if (_controller14.value.isPlaying) {
                            _controller14.pause();
                          } else {
                            // play
                            _controller14.play();
                      ...
                      onPressed: () {
                        for (var answer in listAnswer.answers) {
                          if (_wordCorrectController.text ==
                              apiMockUp.l1.answers[16].resposta)
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                        ...
                        if (_wordCorrectController.text.isEmpty || _wordCorrectController.text != "branco"){
