...
class DivisaoScreen4 extends StatefulWidget {
  static String routeName = "/divisao4_page";

  @override
  _Divisao4FormState createState() => _Divisao4FormState();
}

class _Divisao4FormState extends State<DivisaoScreen4> {
  late VideoPlayerController _controller22;
  ...
  @override
  void initState() {
    _controller22 = VideoPlayerController.asset('assets/videos/divisoes/quarto.mp4');
    _initializeVideoPlayerFuture = _controller22.initialize();

    _controller22.setLooping(true);
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return AspectRatio(
                            aspectRatio: _controller22.value.aspectRatio,
                            child: VideoPlayer(_controller22),
                          );
                        } else {
                  ...
                  SizedBox(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        setState(() {
                          // pause
                          if (_controller22.value.isPlaying) {
                            _controller22.pause();
                          } else {
                            // play
                            _controller22.play();
                      ...
                      onPressed: () {
                        for (var answer in listAnswer.answers) {
                          if (_wordCorrectController.text ==
                              apiMockUp.l1.answers[28].resposta)
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
