...
class DivisaoScreen3 extends StatefulWidget {
  static String routeName = "/divisao3_page";

  @override
  _Divisao3FormState createState() => _Divisao3FormState();
}

class _Divisao3FormState extends State<DivisaoScreen3> {
  late VideoPlayerController _controller21;
  ...
  @override
  void initState() {
    _controller21 = VideoPlayerController.asset('assets/videos/divisoes/casadebanho.mp4');
    _initializeVideoPlayerFuture = _controller21.initialize();

    _controller21.setLooping(true);
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return AspectRatio(
                            aspectRatio: _controller21.value.aspectRatio,
                            child: VideoPlayer(_controller21),
                          );
                        } else {
                  ...
                  SizedBox(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        setState(() {
                          // pause
                          if (_controller21.value.isPlaying) {
                            _controller21.pause();
                          } else {
                            // play
                            _controller21.play();
                      ...
                      onPressed: () {
                        for (var answer in listAnswer.answers) {
                          if (_wordCorrectController.text ==
                              apiMockUp.l1.answers[27].resposta)
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                        ...
                        if (_wordCorrectController.text.isEmpty || _wordCorrectController.text != "casa de banho"){
