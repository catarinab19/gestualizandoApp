...
class DivisaoScreen1 extends StatefulWidget {
  static String routeName = "/divisao1_page";

  @override
  _Divisao1FormState createState() => _Divisao1FormState();
}

class _Divisao1FormState extends State<DivisaoScreen1> {
  late VideoPlayerController _controller19;
  ...
  @override
  void initState() {
    _controller19 = VideoPlayerController.asset('assets/videos/divisoes/saladeestar.mp4');
    _initializeVideoPlayerFuture = _controller19.initialize();

    _controller19.setLooping(true);
                    ...
                    child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState == ConnectionState.done) {
                          return AspectRatio(
                            aspectRatio: _controller19.value.aspectRatio,
                            child: VideoPlayer(_controller19),
                          );
                        } else {
                  ...
                  SizedBox(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        setState(() {
                          // pause
                          if (_controller19.value.isPlaying) {
                            _controller19.pause();
                          } else {
                            // play
                            _controller19.play();
                      ...
                      onPressed: () {
                        for (var answer in listAnswer.answers) {
                          if (_wordCorrectController.text ==
                              apiMockUp.l1.answers[25].resposta)
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                        ...
                        if (_wordCorrectController.text.isEmpty || _wordCorrectController.text != "sala de estar"){
