...
class ObjectoScreen4 extends StatefulWidget {
  static String routeName = "/objeto4_page";

  @override
  _Objecto4FormState createState() => _Objecto4FormState();
}

class _Objecto4FormState extends State<ObjectoScreen4> {
  ...
  @override
  void initState() {
    _controller11 = VideoPlayerController.asset('assets/videos/objetos/telemóvel.mp4');
    _initializeVideoPlayerFuture = _controller11.initialize();

    _controller11.setLooping(true);
                  ...
                  SizedBox(
                    ...
                    child: FloatingActionButton(
                      onPressed: () {
                        setState(() {
                          // pause
                          if (_controller11.value.isPlaying) {
                            _controller11.pause();
                          } else {
                            // play
                            _controller11.play();
                      ...
                      onPressed: () {
                        for (var answer in listAnswer.answers) {
                          if (_wordCorrectController.text ==
                              apiMockUp.l1.answers[9].resposta)
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) =>
                        ...
                        if (_wordCorrectController.text.isEmpty || _wordCorrectController.text != "telemóvel"){
